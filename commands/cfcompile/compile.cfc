component accessors=true {
    ...
    function run(string pathToCompile="", string pathToCompileTo="", string serverName = '', boolean verbose = false) {
        ...
        command('!""#JAVA_HOME#" -cp "#J2EEJAR#;#WEBINF#/lib/cfmx_bootstrap.jar;#WEBINF#/lib/cfx.jar" -Dcoldfusion.classPath=#CFUSION_HOME#/lib/updates,#CFUSION_HOME#/lib -Dcoldfusion.libPath=#CFUSION_HOME#/lib coldfusion.tools.CommandLineInvoker Compiler -deploy -webinf #WEBINF# -webroot #WWWROOT# -cfroot #CFUSION_HOME# -srcdir #APP# -deploydir #APP_COMPILED#"').run(echo=arguments.verbose);
